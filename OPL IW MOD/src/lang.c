...
static char *internalEnglish[LANG_STR_COUNT] = {
    ...
    "Thank you for choosing us, we are PS2 Heavy Gamers and",
    "this our version of (OPL) you can download it together with",
    "our FMCB package at (GITHUB) https://bit.ly/3Dqa8d3",
    // END of OPL_DB tweaks
};
